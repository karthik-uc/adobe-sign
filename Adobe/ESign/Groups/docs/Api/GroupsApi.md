...
# **getGroupDetails**
> \Adobe\ESign\Groups\Model\DetailedGroupInfo getGroupDetails($authorization, $group_id, $x_api_user)
...
[**\Adobe\ESign\Groups\Model\DetailedGroupInfo**](../Model/DetailedGroupInfo.md)
...
# **getGroups**
> \Adobe\ESign\Groups\Model\GroupsInfo getGroups($authorization, $x_api_user, $cursor, $page_size)
...
[**\Adobe\ESign\Groups\Model\GroupsInfo**](../Model/GroupsInfo.md)
...
# **getUsersInGroup**
> \Adobe\ESign\Groups\Model\GroupUsersInfo getUsersInGroup($authorization, $group_id, $x_api_user, $cursor, $page_size)
...
[**\Adobe\ESign\Groups\Model\GroupUsersInfo**](../Model/GroupUsersInfo.md)
