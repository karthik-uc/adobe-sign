...
namespace Adobe\ESign\TransientDocuments\Model;

use \ArrayAccess;
use \Adobe\ESign\TransientDocuments\ObjectSerializer;

/**
 * TransientDocumentResponse Class Doc Comment
 *
 * @category Class
 * @package  Adobe\ESign\TransientDocuments
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransientDocumentResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransientDocumentResponse';
     ...
     *
     * @param string $transient_document_id The unique identifier of the uploaded document that can be used in an agreement or a megaSign or widget creation call
     *
     * @return $this
     */
