...
/**
 * WidgetAdditionalParticipationSetInfo Class Doc Comment
 *
 * @category Class
 * @package  Adobe\ESign\Widgets
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WidgetAdditionalParticipationSetInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WidgetAdditionalParticipationSetInfo';
     ...
     * Sets member_infos
     *
     * @param \Adobe\ESign\Widgets\Model\ParticipantSetMemberInfo[] $member_infos Array of ParticipantInfo objects, containing participant-specific data (email, e.g.) for all the additional participants in the widget
     *
     * @return $this
     */
