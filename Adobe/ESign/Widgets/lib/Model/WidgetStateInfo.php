...
/**
 * WidgetStateInfo Class Doc Comment
 *
 * @category Class
 * @package  Adobe\ESign\Widgets
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WidgetStateInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WidgetStateInfo';
    ...
    protected static $swaggerTypes = [
        'widget_in_active_info' => '\Adobe\ESign\Widgets\Model\WidgetInActiveInfo',
        'state' => 'string'
    ];
     ...
     *
     * @return \Adobe\ESign\Widgets\Model\WidgetInActiveInfo
     */
     ...
     *
     * @param \Adobe\ESign\Widgets\Model\WidgetInActiveInfo $widget_in_active_info Specify custom message which will be displayed  to the user or the URL to which user will be redirected when the widget is accessed in disabled state. This can be specified only in PUT request
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state State of the Widget
     *
     * @return $this
     */
