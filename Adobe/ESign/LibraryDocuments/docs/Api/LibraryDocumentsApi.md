...
# **getDocuments**
> \Adobe\ESign\LibraryDocuments\Model\Documents getDocuments($authorization, $library_document_id, $x_api_user, $x_on_behalf_of_user, $if_none_match, $version_id)
...
# **getEvents**
> \Adobe\ESign\LibraryDocuments\Model\LibraryDocumentEventList getEvents($authorization, $library_document_id, $x_api_user, $x_on_behalf_of_user, $if_none_match)
...
> \Adobe\ESign\LibraryDocuments\Model\DocumentImageUrlsInfo getLibraryDocumentImageUrls($authorization, $library_document_id, $document_id, $x_api_user, $x_on_behalf_of_user, $if_none_match, $image_sizes, $start_page, $end_page)
...
> \Adobe\ESign\LibraryDocuments\Model\LibraryDocumentInfo getLibraryDocumentInfo($authorization, $library_document_id, $x_api_user, $x_on_behalf_of_user, $if_none_match)
...
[**\Adobe\ESign\LibraryDocuments\Model\LibraryDocumentInfo**](../Model/LibraryDocumentInfo.md)
...
# **getLibraryDocuments**
> \Adobe\ESign\LibraryDocuments\Model\LibraryDocuments getLibraryDocuments($authorization, $x_api_user, $x_on_behalf_of_user, $show_hidden_library_documents, $cursor, $page_size)
