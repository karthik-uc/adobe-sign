...
class UserAgreement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserAgreement';
    ...
    protected static $swaggerTypes = [
        ...
        'esign' => 'bool',
        'name' => 'string',
        'display_participant_set_infos' => '\Adobe\ESign\Agreements\Model\DisplayParticipantSetInfo[]',
     ...
     *
     * @return \Adobe\ESign\Agreements\Model\DisplayParticipantSetInfo[]
     */
     ...
     *
     * @param \Adobe\ESign\Agreements\Model\DisplayParticipantSetInfo[] $display_participant_set_infos The most relevant current user set for the agreement. It is typically the next signer if the agreement is from the current user, or the sender if received from another user
     *
     * @return $this
     */
