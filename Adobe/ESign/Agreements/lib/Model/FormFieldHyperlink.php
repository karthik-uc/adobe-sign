...
class FormFieldHyperlink implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'link_type' => 'string',
        'document_location' => '\Adobe\ESign\Agreements\Model\FormFieldLocation',
        'url' => 'string'
    ];
     ...
     *
     * @param \Adobe\ESign\Agreements\Model\FormFieldLocation $document_location Location on the document pointed by the link in case of INTERNAL type link
     *
     * @return $this
     */
