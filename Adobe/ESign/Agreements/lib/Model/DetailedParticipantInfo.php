...
class DetailedParticipantInfo implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Adobe\ESign\Agreements\Model\ParticipantSecurityOption $security_option Security options that apply to the participant. This cannot be changed as part of the PUT call
     *
     * @return $this
     */
