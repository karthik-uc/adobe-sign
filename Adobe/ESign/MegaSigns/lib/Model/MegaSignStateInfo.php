...
/**
 * MegaSignStateInfo Class Doc Comment
 *
 * @category Class
 * @package  Adobe\ESign\MegaSigns
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MegaSignStateInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MegaSignStateInfo';
    ...
    protected static $swaggerTypes = [
        'state' => 'string',
        'mega_sign_cancellation_info' => '\Adobe\ESign\MegaSigns\Model\AgreementCancellationInfo'
    ];
     ...
     * Sets state
     *
     * @param string $state The state to which the megaSign is to be updated. The only valid state for this variable is currently, CANCELLED
     *
     * @return $this
     */
     ...
     *
     * @return \Adobe\ESign\MegaSigns\Model\AgreementCancellationInfo
     */
     ...
     *
     * @param \Adobe\ESign\MegaSigns\Model\AgreementCancellationInfo $mega_sign_cancellation_info Cancellation information for the agreement. Mandatory while cancelling a megaSign
     *
     * @return $this
     */
