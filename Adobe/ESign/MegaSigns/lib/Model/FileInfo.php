...
class FileInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'label' => 'string',
        'url_file_info' => '\Adobe\ESign\MegaSigns\Model\URLFileInfo'
    ];
     ...
     * Gets url_file_info
     *
     * @return \Adobe\ESign\MegaSigns\Model\URLFileInfo
     */
     ...
     * Sets url_file_info
     *
     * @param \Adobe\ESign\MegaSigns\Model\URLFileInfo $url_file_info URL for an external document to add to the agreement
     *
     * @return $this
     */
