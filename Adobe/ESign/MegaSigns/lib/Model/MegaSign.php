 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MegaSign implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MegaSign';
     ...
     * Sets display_date
     *
     * @param \DateTime $display_date The display date for the MegaSign parent agreement. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
     *
     * @return $this
     */
     ...
     * Sets esign
     *
     * @param bool $esign True, if the signature type of the MegaSign parent agreement is ESIGN. False, if the signature type of the MegaSign parent agreement is WRITTEN
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the MegaSign parent agreement
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Current status of the MegaSign parent agreement from the perspective of the user
     *
     * @return $this
     */
