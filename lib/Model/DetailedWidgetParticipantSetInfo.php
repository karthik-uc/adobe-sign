...
class DetailedWidgetParticipantSetInfo implements ModelInterface, ArrayAccess
{
     ...
     * Gets member_infos
     *
     * @return \Adobe\ESign\\Model\DetailedParticipantInfo[]
     */
     ...
     * Sets member_infos
     *
     * @param \Adobe\ESign\\Model\DetailedParticipantInfo[] $member_infos Array of ParticipantInfo objects, containing participant-specific data (e.g. email). All participants in the array belong to the same set
     *
     * @return $this
     */
