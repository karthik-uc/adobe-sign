...
class DetailedWidgetParticipantSetInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
        'member_infos' => '\Swagger\Client\Model\DetailedParticipantInfo[]',
        'order' => 'int',
        'role' => 'string'
    ];
     ...
     * Gets member_infos
     *
     * @return \Swagger\Client\Model\DetailedParticipantInfo[]
     */
     ...
     * Sets member_infos
     *
     * @param \Swagger\Client\Model\DetailedParticipantInfo[] $member_infos Array of ParticipantInfo objects, containing participant-specific data (e.g. email). All participants in the array belong to the same set
     *
     * @return $this
     */
