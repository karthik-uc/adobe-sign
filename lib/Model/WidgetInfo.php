...
class WidgetInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'additional_participant_sets_info' => '\Swagger\Client\Model\WidgetAdditionalParticipationSetInfo[]',
        'auth_failure_info' => '\Swagger\Client\Model\WidgetRedirectionInfo',
        'ccs' => '\Swagger\Client\Model\WidgetCcInfo[]',
        'completion_info' => '\Swagger\Client\Model\WidgetRedirectionInfo',
        ...
        'widget_participant_set_info' => '\Swagger\Client\Model\WidgetParticipantSetInfo'
    ];
     ...
     *
     * @return \Swagger\Client\Model\WidgetAdditionalParticipationSetInfo[]
     */
     ...
     *
     * @param \Swagger\Client\Model\WidgetAdditionalParticipationSetInfo[] $additional_participant_sets_info List of all the participants in the widget except widget signer
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\WidgetRedirectionInfo
     */
     ...
     *
     * @param \Swagger\Client\Model\WidgetRedirectionInfo $auth_failure_info URL and associated properties for the error page the widget signer will be taken after failing to authenticate
     *
     * @return $this
     */
     ...
     * Gets ccs
     *
     * @return \Swagger\Client\Model\WidgetCcInfo[]
     */
     ...
     * Sets ccs
     *
     * @param \Swagger\Client\Model\WidgetCcInfo[] $ccs A list of one or more email addresses that you want to copy on this transaction. The email addresses will each receive an email when the final agreement created through widget is signed. The email addresses will also receive a copy of the document, attached as a PDF file
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\WidgetRedirectionInfo $completion_info URL and associated properties for the success page the widget signer will be taken to after performing desired action on the widget
     *
     * @return $this
     */
     ...
     * Sets file_infos
     *
     * @param \Swagger\Client\Model\FileInfo[] $file_infos A list of one or more files (or references to files) that will be used to create the widget. If more than one file is provided, they will be combined before the widget is created. Library documents are not permitted. Note: Only one of the four parameters in every FileInfo object must be specified
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\SecurityOption $security_option Secondary security parameters for the widget
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\WidgetParticipantSetInfo
     */
     ...
     *
     * @param \Swagger\Client\Model\WidgetParticipantSetInfo $widget_participant_set_info Represents widget participant for whom email should not be provided
     *
     * @return $this
     */
