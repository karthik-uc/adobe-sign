...
class MegaSignCreationInfo implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Adobe\ESign\\Model\ChildAgreementsInfo $child_agreements_info Info corresponding to each child agreement of the megaSign
     *
     * @return $this
     */
     ...
     * Sets external_id
     *
     * @param \Adobe\ESign\\Model\ExternalId $external_id An arbitrary value from your system, which can be specified at sending time and then later returned or queried
     *
     * @return $this
     */
     ...
     *
     * @param \Adobe\ESign\\Model\PostSignOption $post_sign_option URL and associated properties for the success page the user will be taken to after completing the signing process
     *
     * @return $this
     */
