...
class FileInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'document' => '\Adobe\ESign\\Model\Document',
        'library_document_id' => 'string',
        'label' => 'string',
        'url_file_info' => '\Adobe\ESign\\Model\URLFileInfo'
    ];
     ...
     * Sets document
     *
     * @param \Adobe\ESign\\Model\Document $document A document that is associated with the agreement. This field cannot be provided in POST call. In case of GET call, this is the only field returned in the response
     *
     * @return $this
     */
     ...
     * Gets url_file_info
     *
     * @return \Adobe\ESign\\Model\URLFileInfo
     */
     ...
     * Sets url_file_info
     *
     * @param \Adobe\ESign\\Model\URLFileInfo $url_file_info URL for an external document to add to the agreement
     *
     * @return $this
     */
