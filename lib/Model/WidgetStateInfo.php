...
class WidgetStateInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'state' => 'string',
        'widget_in_active_info' => '\Swagger\Client\Model\WidgetInActiveInfo'
    ];
     ...
     *
     * @return \Swagger\Client\Model\WidgetInActiveInfo
     */
     ...
     *
     * @param \Swagger\Client\Model\WidgetInActiveInfo $widget_in_active_info Specify custom message which will be displayed  to the user or the URL to which user will be redirected when the widget is accessed in disabled state. This can be specified only in PUT request
     *
     * @return $this
     */
