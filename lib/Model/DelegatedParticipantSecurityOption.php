...
class DelegatedParticipantSecurityOption implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'phone_info' => '\Adobe\ESign\\Model\PhoneInfo'
    ];
     ...
     * Sets phone_info
     *
     * @param \Adobe\ESign\\Model\PhoneInfo $phone_info The phoneInfo required for the participant to view and sign the document
     *
     * @return $this
     */
