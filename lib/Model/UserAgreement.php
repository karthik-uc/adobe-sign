...
class UserAgreement implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'esign' => 'bool',
        'name' => 'string',
        'display_participant_set_infos' => '\Swagger\Client\Model\DisplayParticipantSetInfo[]',
     ...
     *
     * @return \Swagger\Client\Model\DisplayParticipantSetInfo[]
     */
     ...
     *
     * @param \Swagger\Client\Model\DisplayParticipantSetInfo[] $display_participant_set_infos The most relevant current user set for the agreement. It is typically the next signer if the agreement is from the current user, or the sender if received from another user
     *
     * @return $this
     */
