...
/**
 * LibraryDocumentCreationInfoV6 Class Doc Comment
 *
 * @category Class
 * @package  Adobe\ESign\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LibraryDocumentCreationInfoV6 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LibraryDocumentCreationInfoV6';
     ...
     * Sets created_date
     *
     * @param \DateTime $created_date Date when library document was created. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
     *
     * @return $this
     */
     ...
     * Sets file_infos
     *
     * @param \Adobe\ESign\\Model\FileInfo[] $file_infos A list of one or more files (or references to files) that will be used to create the template. If more than one file is provided, they will be combined into one PDF. Note: Only a single parameter in every FileInfo object must be specified
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id The unique identifier that is used to refer to the library template. It will be ignored in POST call
     *
     * @return $this
     */
