...
class FormFieldConditionPredicate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'value' => 'string',
        'operator' => 'string',
        'field_location_index' => '\Adobe\ESign\\Model\Int'
    ];
     ...
     *
     * @param \Adobe\ESign\\Model\Int $field_location_index Index of the location of the form field used in the predicate
     *
     * @return $this
     */
