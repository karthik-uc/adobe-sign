...
class ParticipantSetMemberInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'email' => 'string',
        'security_option' => '\Adobe\ESign\\Model\ParticipantSecurityOption'
    ];
     ...
     *
     * @param \Adobe\ESign\\Model\ParticipantSecurityOption $security_option Security options that apply to the participant
     *
     * @return $this
     */
