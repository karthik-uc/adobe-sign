...
class WidgetAdditionalParticipationSetInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'member_infos' => '\Swagger\Client\Model\ParticipantSetMemberInfo[]',
        'order' => 'int',
        'role' => 'string'
    ];
     ...
     * Gets member_infos
     *
     * @return \Swagger\Client\Model\ParticipantSetMemberInfo[]
     */
