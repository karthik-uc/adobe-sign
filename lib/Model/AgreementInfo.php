...
class AgreementInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'string',
        'state' => 'string',
        'merge_field_info' => '\Adobe\ESign\\Model\MergefieldInfo[]',
        'first_reminder_delay' => 'int',
        'email_option' => '\Adobe\ESign\\Model\EmailOption',
        'signature_type' => 'string',
        'external_id' => '\Adobe\ESign\\Model\ExternalId',
        'message' => 'string',
        'device_info' => '\Adobe\ESign\\Model\OfflineDeviceInfo',
        'reminder_frequency' => 'string',
        'created_date' => '\DateTime',
        'participant_sets_info' => '\Adobe\ESign\\Model\ParticipantSetInfo[]',
        'expiration_time' => '\Adobe\ESign\\Model\\DateTime',
        'form_field_layer_templates' => '\Adobe\ESign\\Model\FileInfo[]',
        'name' => 'string',
     ...
     *
     * @param \Adobe\ESign\\Model\SecurityOption $security_option Optional secondary security parameters for the agreement. Should not be provided in offline agreement creation.
     *
     * @return $this
     */
     ...
     *
     * @param \Adobe\ESign\\Model\PostSignOption $post_sign_option URL and associated properties for the success page the user will be taken to after completing the signing process. Should not be provided in offline agreement creation.
     *
     * @return $this
     */
     ...
     * Sets email_option
     *
     * @param \Adobe\ESign\\Model\EmailOption $email_option Email configurations for the agreement. Should not be provided in offline agreement creation.
     *
     * @return $this
     */
     ...
     * Sets external_id
     *
     * @param \Adobe\ESign\\Model\ExternalId $external_id An arbitrary value from your system, which can be specified at sending time and then later returned or queried. Should not be provided in offline agreement creation.
     *
     * @return $this
     */
     ...
     * Sets device_info
     *
     * @param \Adobe\ESign\\Model\OfflineDeviceInfo $device_info Device info of the offline device. It should only be provided in case of offline agreement creation.
     *
     * @return $this
     */
     ...
     *
     * @param \Adobe\ESign\\Model\FileInfo[] $form_field_layer_templates Specifies the form field layer template or source of form fields to apply on the files in this transaction. If specified, the FileInfo for this parameter must refer to a form field layer template via libraryDocumentId or libraryDocumentName, or if specified via transientDocumentId or documentURL, it must be of a supported file type. Note: Only one of the four parameters in every FileInfo object must be specified
     *
     * @return $this
     */
