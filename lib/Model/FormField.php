...
class FormField implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'masked' => 'bool',
        'min_length' => '\Adobe\ESign\\Model\Int',
        'origin' => 'string',
        'tooltip' => 'string',
        ...
        'read_only' => 'bool',
        'font_name' => 'string',
        'conditional_action' => '\Adobe\ESign\\Model\FormFieldConditionalAction',
        'name' => 'string',
        'font_size' => 'double',
        ...
        'alignment' => 'string',
        'font_color' => 'string',
        'max_length' => '\Adobe\ESign\\Model\Int'
    ];
     ...
     * Sets min_length
     *
     * @param \Adobe\ESign\\Model\Int $min_length Minimum length of the input text field in terms of no. of characters
     *
     * @return $this
     */
     ...
     *
     * @param \Adobe\ESign\\Model\FormFieldConditionalAction $conditional_action A predicate (or set of predicates) that determines whether this field is visible and enabled.
     *
     * @return $this
     */
     ...
     * Sets max_length
     *
     * @param \Adobe\ESign\\Model\Int $max_length Maximum length of the input text field in terms of no. of characters
     *
     * @return $this
     */
