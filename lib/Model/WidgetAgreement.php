...
class WidgetAgreement implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'display_participant_set_infos' => '\Swagger\Client\Model\DisplayWidgetParticipantSetInfo[]',
        'id' => 'string',
        'esign' => 'bool',
        'hidden' => 'bool',
     ...
     *
     * @return \Swagger\Client\Model\DisplayWidgetParticipantSetInfo[]
     */
     ...
     *
     * @param \Swagger\Client\Model\DisplayWidgetParticipantSetInfo[] $display_participant_set_infos The most relevant current user set for the agreement. It is typically the next signer if the agreement is from the current user, or the sender if received from another user
     *
     * @return $this
     */
