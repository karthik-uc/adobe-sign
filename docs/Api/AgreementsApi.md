...
# **getAgreements**
> \Swagger\Client\Model\UserAgreements getAgreements($authorization, $x_api_user, $x_on_behalf_of_user, $external_id, $show_hidden_agreements, $cursor, $page_size)
...
# **getAllDocuments**
> \Swagger\Client\Model\AgreementDocuments getAllDocuments($authorization, $agreement_id, $x_api_user, $x_on_behalf_of_user, $if_none_match, $version_id, $participant_id, $supporting_document_content_format)
...
> \Swagger\Client\Model\DocumentsImageUrlsInfo getAllDocumentsImageUrls($authorization, $agreement_id, $x_api_user, $x_on_behalf_of_user, $version_id, $participant_id, $image_sizes, $include_supporting_documents_image_urls, $show_image_availability_only)
...
> \Swagger\Client\Model\CombinedDocumentPagesInfo getCombinedDocumentPagesInfo($authorization, $agreement_id, $x_api_user, $x_on_behalf_of_user, $if_none_match, $include_supporting_documents_pages_info)
...
> \Swagger\Client\Model\DocumentUrl getCombinedDocumentUrl($authorization, $agreement_id, $x_api_user, $x_on_behalf_of_user, $version_id, $participant_id, $attach_supporting_documents, $attach_audit_report)
...
> \Swagger\Client\Model\AgreementDocumentImageUrlsInfo getDocumentImageUrls($authorization, $agreement_id, $document_id, $x_api_user, $x_on_behalf_of_user, $image_sizes, $show_image_availability_only, $start_page, $end_page)
...
# **getEvents**
> \Swagger\Client\Model\AgreementEventList getEvents($authorization, $agreement_id, $x_api_user, $x_on_behalf_of_user, $if_none_match)
...
# **getParticipantSet**
> \Swagger\Client\Model\DetailedParticipantSetInfo getParticipantSet($authorization, $agreement_id, $participant_set_id, $x_api_user, $x_on_behalf_of_user, $if_none_match)
