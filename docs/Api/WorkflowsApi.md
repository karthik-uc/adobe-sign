...
# **getWorkflows**
> \Swagger\Client\Model\UserWorkflows getWorkflows($authorization, $x_api_user, $include_draft_workflows, $include_inactive_workflows, $group_id)
...
[**\Swagger\Client\Model\UserWorkflows**](../Model/UserWorkflows.md)
