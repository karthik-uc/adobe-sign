# Swagger\Client\TransientDocumentsApi
...
> \Swagger\Client\Model\TransientDocumentResponse createTransientDocument($authorization, $file, $x_api_user, $x_on_behalf_of_user, $file_name, $mime_type)
...
$apiInstance = new Swagger\Client\Api\TransientDocumentsApi(
...
[**\Swagger\Client\Model\TransientDocumentResponse**](../Model/TransientDocumentResponse.md)
