# Adobe\ESign\\TransientDocumentsApi
...
> \Adobe\ESign\\Model\TransientDocumentResponse createTransientDocument($authorization, $file, $x_api_user, $x_on_behalf_of_user, $file_name, $mime_type)
