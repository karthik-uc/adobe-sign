...
$widget_info = new \Swagger\Client\Model\WidgetInfo(); // \Swagger\Client\Model\WidgetInfo | Information about the widget that you want to create.
 ...
 **widget_info** | [**\Swagger\Client\Model\WidgetInfo**](../Model/WidgetInfo.md)| Information about the widget that you want to create. |
...
# **getEvents**
> \Swagger\Client\Model\WidgetEventList getEvents($authorization, $widget_id, $x_api_user, $x_on_behalf_of_user, $if_none_match)
...
# **getParticipantSet**
> \Swagger\Client\Model\DetailedWidgetParticipantSetInfo getParticipantSet($authorization, $widget_id, $participant_set_id, $x_api_user, $x_on_behalf_of_user, $if_none_match)
...
# **getWidgetDocuments**
> \Swagger\Client\Model\WidgetDocuments getWidgetDocuments($authorization, $widget_id, $x_api_user, $x_on_behalf_of_user, $if_none_match, $version_id, $participant_id)
...
# **getWidgetInfo**
> \Swagger\Client\Model\WidgetInfo getWidgetInfo($authorization, $widget_id, $x_api_user, $x_on_behalf_of_user, $if_none_match)
...
[**\Swagger\Client\Model\WidgetInfo**](../Model/WidgetInfo.md)
