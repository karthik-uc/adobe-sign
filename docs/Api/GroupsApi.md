...
# **getGroupDetails**
> \Adobe\ESign\\Model\DetailedGroupInfo getGroupDetails($authorization, $group_id, $x_api_user)
...
# **getGroups**
> \Adobe\ESign\\Model\GroupsInfo getGroups($authorization, $x_api_user, $cursor, $page_size)
...
# **getUsersInGroup**
> \Adobe\ESign\\Model\GroupUsersInfo getUsersInGroup($authorization, $group_id, $x_api_user, $cursor, $page_size)
