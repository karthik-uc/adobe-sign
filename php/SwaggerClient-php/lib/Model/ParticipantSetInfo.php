...
class ParticipantSetInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets member_infos
     *
     * @param \Swagger\Client\Model\ParticipantSetMemberInfo[] $member_infos Array of ParticipantInfo objects, containing participant-specific data (e.g. email). All participants in the array belong to the same set
     *
     * @return $this
     */
