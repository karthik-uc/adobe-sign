...
class LibraryDocumentInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets file_infos
     *
     * @param \Swagger\Client\Model\FileInfo[] $file_infos A list of one or more files (or references to files) that will be used to create the template. If more than one file is provided, they will be combined into one PDF. Note: Only a single parameter in every FileInfo object must be specified
     *
     * @return $this
     */
